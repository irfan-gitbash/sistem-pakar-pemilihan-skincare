    ...
    <div class="container mx-auto px-4 py-8 flex-grow">
        <div class="max-w-4xl mx-auto w-full">
            ...
            <div class="mt-6 flex justify-center space-x-4 no-print">
                ...
                <a href="dashboard.php" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                    Back to List
                </a>
            </div>
        </div>
